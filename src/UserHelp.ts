 ...
 */
 ...
 export class DebuggerCommandsPanel {
	 ...
	 private _getHtmlForWebview(webview: vscode.Webview) {
		 ...
		 const oneapiReferenceSheetLink = 'https://software.intel.com/content/www/us/en/develop/download/gdb-reference-sheet.html';
		 const oneapiUserManualLink = 'https://software.intel.com/content/www/us/en/develop/download/gdb-oneapi-user-guide.html';
						...
						<div class="left-menu-positioning">
							...
							<div class="documentation-resources-list-wrapper">
								<ul class="documentation-resources" id="documentation-resources">
									...
									<li class="inner"><a class="header-link" href="${oneapiUserManualLink}">User Manual</a></li>
									<li class="inner"><a class="header-link" href="${oneapiReferenceSheetLink}">Cheatsheet</a></li>
